        ...
        <section className="w-100 py-bottom-section">
            ...
            <div className="form-container flex justify-center align-center">
                ...
                <form ref={formRef} onSubmit={e => {
                    ...
                    className='email-form px-lg relative rounded flex flex-column justify-center align-start gap-sm'
                >
                    ...
                    <div className='flex flex-column justify-center align-start'>
                        ...
                        <textarea className='rounded form-input font-1 text-sm border-2 p-xsm border-box' name="message" id="message"
